...
RELEASES = {
    ...
    # The cumulative release_v6 (1055 problems, all six slices unioned). The vendor cards that
    # say "LiveCodeBench v6" do not say which of the two they mean, so both are scoreable.
    "livecodebench_v6_cumulative": "release_v6_cumulative.jsonl",
