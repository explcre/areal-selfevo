...
Stated explicitly so the gap is not mistaken for an omission: the solved/unsolved split of
the $57.4\%$ under the fixed metric; any arm in which routed units \emph{gain} a signal
