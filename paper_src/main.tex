...
We report the negative result that located this leverage: a token-level version of the same
idea, reaching $1.7\%$ of tokens, moved held-out accuracy by less than the noise floor.
Every capability is flag-gated and reduces to unmodified GRPO when disabled.
\end{abstract}
