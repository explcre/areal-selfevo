...
def main(args):
    ...
    swe_kwargs = {
        ...
        "max_no_thinking_ratio": config.swe.max_no_thinking_ratio,
        "split_mode": config.swe.split_mode,
        "random_strip_thinking_prob": config.swe.random_strip_thinking_prob,
        "random_strip_thinking_seed": config.swe.random_strip_thinking_seed,
        "n_thinking_variants": config.swe.n_thinking_variants,
        "dump_dir": dump_dir,
